describe('test_name', function() {
  ...
  it('what_it_does', function() {
     ...
     cy.get('.form-comtent > .mb-3 > .p-element > #pn_id_69 > .p-element:nth-child(1)').click()
  
     cy.get('.p-scroller-viewport > .p-scroller > #pn_id_69_list > .p-element > #pn_id_69_0').click()
  
     cy.get('.mb-3 > .row > #mat-mdc-checkbox-1 > .mdc-form-field > .mdc-label').click()
  
     cy.get('.row > #mat-mdc-checkbox-1 > .mdc-form-field > .mdc-checkbox > #mat-mdc-checkbox-1-input').check('on')
  
     cy.get('.mb-3 > .row > #mat-mdc-checkbox-2 > .mdc-form-field > .mdc-label').click()
  
     cy.get('.row > #mat-mdc-checkbox-2 > .mdc-form-field > .mdc-checkbox > #mat-mdc-checkbox-2-input').check('on')
  
     cy.get('.row > #mat-mdc-checkbox-3 > .mdc-form-field > .mdc-checkbox > .mat-mdc-checkbox-touch-target').click()
  
     cy.get('#mat-expansion-panel-header-0 > .mat-content > .mat-expansion-panel-header-title > .title-container > .mat-icon').click()
